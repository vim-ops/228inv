...
export default function AllHistoryPage() {
  // 全履歴を取得するため、categoryは指定しない
  const { inboundHistory, outboundHistory, isLoading } = useInventory(undefined);
  ...
  return (
    <ProductLayout type="history" title="全履歴">
      {isLoading ? (
        <div>Loading...</div>
      ) : (
